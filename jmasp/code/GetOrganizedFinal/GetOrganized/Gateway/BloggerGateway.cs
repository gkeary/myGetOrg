...
namespace GetOrganized.Gateway
{
    public class BloggerGateway
    {
        //Replace blogId with your own blogger id
        private const long blogId = 2580952471083668495;
        //Replace ipAddressOfSite with your address and make sure
        //your firewalls are configured to allow the incoming traffic from Google
        private const string ipAddressOfSite = "10.1.10.12:1901";
